import { FETCH_TODOS, RECEIVE_TODOS } from '../constants/actionTypes'
import { createTodosResource, getTodosResource } from '../lib/api'
...
export const createAndGetTodos = values => dispatch =>
